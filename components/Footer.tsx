...
const Footer: React.FC<FooterProps> = ({ onPageChange }) => {
  ...
  return (
    <div className="bg-blue-50 shadow-lg p-4 pt-12 flex justify-between  border-gray-300">
      <div className="mx-10 lg:mx-24 text-gray-600 relative z-10">
        <div className="flex flex-col sm:flex-row  items-top justify-between align-top">
          ...
          <div className="lg:flex-1 text-left py-10 sm:py-1" >
          ...
          <div className="lg:flex-1">
            ...
            <address className="flex flex-col text-sm mt-2">
